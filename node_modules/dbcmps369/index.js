...
class DataStore {
    ...
    async create(table, data) {
        ...
        console.log('create():', sql, data.map(d => d.value));
    ...
    async read(table, query) {
        ...
        console.log('read():', sql, query.map(d => d.value));
    ...
    async delete(table, query) {
        ...
        console.log('delete():', sql, query.map(d => d.value));
        return await this.db.all(
            sql, query.map(d => d.value)
        );
    }
